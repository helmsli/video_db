...
-- 用于按照orderID查询
CREATE INDEX Idx_userOrder_orderid ON userOrder (createTime ASC, userId ASC, orderId ASC);
-- 用于按照状态查询
CREATE INDEX idx_userOrder_status ON userOrder (createTime ASC, userId ASC, status ASC, orderId ASC);
